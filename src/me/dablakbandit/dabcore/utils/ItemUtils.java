...
import me.dablakbandit.dabcore.utils.itemutils.DefaultItemUtils;
import me.dablakbandit.dabcore.utils.itemutils.IItemUtils;
import me.dablakbandit.dabcore.utils.itemutils._164ItemUtils;
import me.dablakbandit.dabcore.utils.itemutils._1710ItemUtils;
...
public class ItemUtils{
	...
	private static IItemUtils load(){
		...
		System.out.print("[DabCore] Failed to load ItemUtils, disabling to ensure stability.");
		Bukkit.getPluginManager().disablePlugin(DabCorePlugin.getInstance());
		return null;
	}
